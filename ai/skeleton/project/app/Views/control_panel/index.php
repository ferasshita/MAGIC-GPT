...
?>
<!DOCTYPE html>
<html class="<?php echo view('includes/mode'); ?>" translate="no" lang="<?php echo langs('html_lang'); ?>" dir="<?php echo langs('html_dir'); ?>">
<head>
                                    ...
                                    <script type="text/javascript">
                                        function signupUser(){
                                            ...
                                            $.ajax({
                                                ...
                                                data:{'req':'admin_sign','fn':fullname,'un':username,'em':emailAdd,'pd':password,'cpd':cpassword,'gr':'sign','typ':typt},
                                                beforeSend:function(){
