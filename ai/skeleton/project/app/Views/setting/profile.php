  ...
  <!-- name input -->
  <div class="form-group"><label><?php echo langs('name'); ?></label>
  <input type="text" name="name" value="<?php echo $_SESSION['name']; ?>" placeholder="<?php echo langs('name'); ?>" class="form-control">
  </div>

  <!-- shop input -->
  <?php if($_SESSION['type'] == "boss"){ ?>
  <div class="form-group"><label><?php echo langs('shop'); ?></label>
  ...
  <?php if($_SESSION['type'] == "boss"){ ?>
  <div class="form-group"><label><?php echo langs('main_currency'); ?></label>
  ...
  <?php } ?>
  <div class="form-group"><label><?php echo langs('home_transaction'); ?></label>
  <select name="home_transaction" id="home_transaction" class="form-control">
  <option value="1" <?php if ($_SESSION['home_transaction'] == '1') {echo 'selected';} ?>><?php echo langs('cash'); ?></option>
  <option value="2" <?php if ($_SESSION['home_transaction'] == '2') {echo 'selected';} ?>><?php echo langs('local'); ?></option>
  </select>
  </div>
<?php
...
foreach($udata as $rowx){
 ...
 ?>
  ...
  <label class="fix-font" for="basicx-checkbox"><?php echo langs('help'); ?></label>
  ...
  <label class="fix-font" for="basicx-checkbox1"><?php echo langs('hide_trsh'); ?></label>
